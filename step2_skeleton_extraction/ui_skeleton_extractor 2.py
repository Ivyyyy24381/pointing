    ...
    def initialize_detector(self):
        ...
        try:
            ...
            if detect_dog:
                ...
                print("✅ Dog detector initialized (bottom 60% of image)")
            else:
            ...
            if detect_baby:
                ...
                print("✅ Baby detector initialized (bottom 60% of image)")
            else:
    ...
    def auto_save_results(self, pointing_hand: str = None):
        ...
        if self.dog_results:
            ...
            try:
                ...
                generate_subject_plots(self.trial_path, subject_type='dog', subject_name='Dog', fps=30.0)
            except Exception as e:
        ...
        if self.baby_results:
            ...
            try:
                from step2_skeleton_extraction.subject_plot_generator import generate_subject_plots
                generate_subject_plots(self.trial_path, subject_type='baby', subject_name='Baby', fps=30.0)
            except Exception as e:
