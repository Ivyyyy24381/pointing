#!/usr/bin/env python3
"""
Baby 2D Trace Visualizer

Creates a top-down view (X-Z plane) of the baby's movement trace with:
- Rainbow colored dots showing the baby's path over time
- Smooth curved rainbow line fitted through the dots
- Target locations as gray squares
- Grid and axis labels
- Fixed axis limits based on target locations
"""
...
class BabyTraceVisualizer:
    """Visualize baby movement trace in 2D top-down view."""
    ...
    def create_trace_plot(self,
                         ...
                         title: str = "2D Trace (Top View) - Baby",
        ...
        # Extract trace points (X, Z coordinates) from baby landmarks_3d
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Create baby 2D trace visualization')
    parser.add_argument('--baby-results', type=str, required=True,
                       help='Path to skeleton_2d.json')
    parser.add_argument('--targets', type=str,
                       help='Path to target_detections_cam_frame.json')
    parser.add_argument('--output', type=str, required=True,
                       help='Output image path')
    parser.add_argument('--title', type=str, default='2D Trace (Top View) - Baby',
                       help='Plot title')
    ...
    visualizer.create_trace_plot(
        baby_results_path=Path(args.baby_results),
